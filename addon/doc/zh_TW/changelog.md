...
不能只有我一個人中毒，你們也要一起來陪我。

### 新增項目

1. ギリギリあい
Youtube 聊天室：新增朗讀訊息發送者及其對應開關。
2. キリキリまい
Youtube 聊天室：新增朗讀會籍贈送訊息及其對應開關。
3. ギリギリあい
新增 Bilibili 字幕支援，感謝 Eureka 在 NVDA 台灣的提案。
キリキリまい

### 修改項目

1. ギリギリあい
字幕閱讀器核心：將尋找字幕或聊天室較慢的程式改為非同步進行，避免字幕閱讀器讓 NVDA 反應速度變慢。
キリキリまい
P.S 這是此版本最大的更新，並且可能不穩定，未來將可能出現頻率較高的修正版。
ギリギリあい
現在不用擔心閱讀器找字幕或聊天室，因為網頁元素太多而花較長的時間了，閱讀器跑起來吧，快 ... 還要更快。
2. キリキリまい
Netflix: 調整尋找字幕的方式，使得當開啟 Teleparty 實惠找不到字幕的問題，感謝 T.Y 思訓反映此問題。

### 修正巷木

1. ギリギリあい
修正再輸入手勢當中找不到字幕閱讀器的錯誤 (issue #5) 。
キリキリまい
