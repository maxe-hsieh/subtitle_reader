...
我的測試流程如下：  
   1. 從這裡安裝擴充功能：  
   [Movie Subtitles](https://chromewebstore.google.com/detail/movie-subtitles/ifimcneililngppkpddcliecbpcgdjag)
   2. 下載字幕檔：  
   [葬送的芙莉蓮 第二季 第36話【壯烈的犧牲】](https://www.opensubtitles.org/zh/subtitleserve/sub/13630886)
   3. 取出裡面的 srt 檔案，檔名匯市亂碼，可以改成正確的標題，等一下比較好找。
   4. 打開影片連結：  
   [葬送的芙莉蓮 第二季 第36話【壯烈的犧牲】｜Muse木棉花 動畫 線上看 - YouTube](https://youtu.be/UEJqIQzWht4)
...
來源：
https://youtu.be/OzGVz1ClxIc

### 更新項目

1. 新增 Sky Showtime 字幕支援，感謝 Daniel Gheorghe 的提案。
2. 新增羅馬尼亞語翻譯，感謝 Daniel Gheorghe. 
3. 聲音寒士庫新增 64 位元版 NVDA 支援，感謝 hwf1324. 
4. 使用新版附加元件樣板，感謝 hwf1324. 
5. 新的附加元件樣板史的字幕閱讀器無法檢查更新，故暫時相容舊版的檢查更新方式，下一版刪除，故下次更新之前沒有升級到 3.6 則無法使用更新功能。
6. 刪除一些不必要的檔案，感謝 hwf1324. 
7. 更新俄語翻譯，感謝 Kostenkov-2021. 

---

## V3.5, 2025.10.23

版本代號：心訊 Heart Signal

影片來源：
https://youtu.be/NEC1JChA6ws

### 更新項目

1. 新增 HBO Max 字幕支援，感謝 TY 的提案與提供測試帳號。
2. 新增 Yandex 瀏覽器支援，感謝 Fatih Yüksek 的提案。 (Issue #41)

### 修正巷木

1. Netflix: 修正偶爾出現看不見的對話框，導致找不到字幕的錯誤。
2. Netflix: 修正全螢幕播放時找不到字幕的錯誤。
3. Animation Digital Network: 修正無法閱讀字幕的錯誤，感謝 blal 的協作開發。
4. 調整版本號碼規則，以避免 NVDA 附加元件商店認為舊版字幕閱讀器比較新的錯誤。
...
1. 完成 NVDA 2025.1rc1 相容性測試。
2. 字幕閱讀器選單：新增「開啟最新版本更新日誌」功能，會開啟 github 上的版本，可在不更新的情況下，方便的察看新版日誌。
3. 更新視窗：新增音樂音量滑桿，無法使用 NVDA 音訊迴避的替代方案 (Issue #33). 
...
1. 完成 Issue #29: 新增「手動閱讀字幕」功能，用於不需要聽讀每個新出現字幕的情況（感謝 davidacm 的提案）。
...
自從我去找有再播《葬送的芙莉蓮》的所有影音平台之後，就應該很難再有 CC 字幕需要閱讀器的支援了，所以閱讀器的更新差不多要結束了，除了我想更新閱讀聊天室之外啦。
