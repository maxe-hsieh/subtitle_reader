...
if "64 bit" in sys.version:
	bass_module = ctypes.WinDLL(os.path.dirname(__file__) + r'\x64\bass')
else:
	bass_module = ctypes.WinDLL(os.path.dirname(__file__) + r'\bass')
...
BASS_SetConfig = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong)(('BASS_SetConfig', bass_module))
...
BASS_SetConfigPtr = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_void_p)(('BASS_SetConfigPtr', bass_module))
...
BASS_Update = func_type(ctypes.c_bool, ctypes.c_ulong)(('BASS_Update', bass_module))
...
BASS_PluginFree = func_type(ctypes.c_bool, HPLUGIN)(('BASS_PluginFree', bass_module))
...
BASS_Set3DFactors = func_type(ctypes.c_bool, ctypes.c_float, ctypes.c_float, ctypes.c_float)(('BASS_Set3DFactors', bass_module))
#BOOL BASSDEF(BASS_Get3DFactors)(float *distf, float *rollf, float *doppf);
BASS_Get3DFactors = func_type(ctypes.c_bool, ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float))(('BASS_Get3DFactors', bass_module))
...
BASS_Set3DPosition = func_type(ctypes.c_bool, ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR))(('BASS_Set3DPosition', bass_module))
#BOOL BASSDEF(BASS_Get3DPosition)(BASS_3DVECTOR *pos, BASS_3DVECTOR *vel, BASS_3DVECTOR *front, BASS_3DVECTOR *top);
BASS_Get3DPosition = func_type(ctypes.c_bool, ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR))(('BASS_Get3DPosition', bass_module))
...
BASS_MusicLoad = func_type(HMUSIC, ctypes.c_bool, ctypes.c_void_p, QWORD, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong)(('BASS_MusicLoad', bass_module))
#BOOL BASSDEF(BASS_MusicFree)(HMUSIC handle);
BASS_MusicFree = func_type(ctypes.c_bool, HMUSIC)(('BASS_MusicFree', bass_module))

#HSAMPLE BASSDEF(BASS_SampleLoad)(BOOL mem, const void *file, QWORD offset, DWORD length, DWORD max, DWORD flags);
BASS_SampleLoad = func_type(HSAMPLE, ctypes.c_bool, ctypes.c_void_p, QWORD, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong)(('BASS_SampleLoad', bass_module))
...
BASS_SampleFree = func_type(ctypes.c_bool, HSAMPLE)(('BASS_SampleFree', bass_module))
#BOOL BASSDEF(BASS_SampleSetData)(HSAMPLE handle, const void *buffer);
BASS_SampleSetData = func_type(ctypes.c_bool, HSAMPLE, ctypes.c_void_p)(('BASS_SampleSetData', bass_module))
#BOOL BASSDEF(BASS_SampleGetData)(HSAMPLE handle, void *buffer);
BASS_SampleGetData = func_type(ctypes.c_bool, HSAMPLE, ctypes.c_void_p)(('BASS_SampleGetData', bass_module))
#BOOL BASSDEF(BASS_SampleGetInfo)(HSAMPLE handle, BASS_SAMPLE *info);
BASS_SampleGetInfo = func_type(ctypes.c_bool, HSAMPLE, ctypes.POINTER(BASS_SAMPLE))(('BASS_SampleGetInfo', bass_module))
#BOOL BASSDEF(BASS_SampleSetInfo)(HSAMPLE handle, const BASS_SAMPLE *info);
BASS_SampleSetInfo = func_type(ctypes.c_bool, HSAMPLE, ctypes.POINTER(BASS_SAMPLE))(('BASS_SampleSetInfo', bass_module))
#HCHANNEL BASSDEF(BASS_SampleGetChannel)(HSAMPLE handle, BOOL onlynew);
BASS_SampleGetChannel = func_type(HCHANNEL, HSAMPLE, ctypes.c_bool)(('BASS_SampleGetChannel', bass_module))
...
BASS_SampleStop = func_type(ctypes.c_bool, HSAMPLE)(('BASS_SampleStop', bass_module))
...
BASS_StreamCreateURL = func_type(HSTREAM, ctypes.c_char_p, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_void_p, ctypes.c_void_p)(('BASS_StreamCreateURL', bass_module))
...
BASS_RecordGetDeviceInfo = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(BASS_DEVICEINFO))(('BASS_RecordGetDeviceInfo', bass_module))
#BOOL BASSDEF(BASS_RecordInit)(int device);
BASS_RecordInit = func_type(ctypes.c_bool, ctypes.c_int)(('BASS_RecordInit', bass_module))
#BOOL BASSDEF(BASS_RecordSetDevice)(DWORD device);
BASS_RecordSetDevice = func_type(ctypes.c_bool, ctypes.c_ulong)(('BASS_RecordSetDevice', bass_module))
...
BASS_RecordFree = func_type(ctypes.c_bool)(('BASS_RecordFree', bass_module))
#BOOL BASSDEF(BASS_RecordGetInfo)(BASS_RECORDINFO *info);
BASS_RecordGetInfo = func_type(ctypes.c_bool, ctypes.POINTER(BASS_RECORDINFO))(('BASS_RecordGetInfo', bass_module))
...
BASS_RecordSetInput = func_type(ctypes.c_bool, ctypes.c_int, ctypes.c_ulong, ctypes.c_float)(('BASS_RecordSetInput', bass_module))
...
BASS_ChannelSetDevice = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong)(('BASS_ChannelSetDevice', bass_module))
...
BASS_ChannelGetInfo = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(BASS_CHANNELINFO))(('BASS_ChannelGetInfo', bass_module))
...
BASS_ChannelUpdate = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong)(('BASS_ChannelUpdate', bass_module))
#BOOL BASSDEF(BASS_ChannelLock)(DWORD handle, BOOL lock);
BASS_ChannelLock = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_bool)(('BASS_ChannelLock', bass_module))
...
BASS_ChannelGetAttribute = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong, ctypes.POINTER(ctypes.c_float))(('BASS_ChannelGetAttribute', bass_module))
#BOOL BASSDEF(BASS_ChannelSlideAttribute)(DWORD handle, DWORD attrib, float value, DWORD time);
BASS_ChannelSlideAttribute = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_float, ctypes.c_ulong)(('BASS_ChannelSlideAttribute', bass_module))
#BOOL BASSDEF(BASS_ChannelIsSliding)(DWORD handle, DWORD attrib);
BASS_ChannelIsSliding = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong)(('BASS_ChannelIsSliding', bass_module))
#BOOL BASSDEF(BASS_ChannelSet3DAttributes)(DWORD handle, int mode, float min, float max, int iangle, int oangle, float outvol);
BASS_ChannelSet3DAttributes = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_int, ctypes.c_float, ctypes.c_float, ctypes.c_int, ctypes.c_int, ctypes.c_float)(('BASS_ChannelSet3DAttributes', bass_module))
...
BASS_ChannelGet3DAttributes = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(ctypes.c_ulong), ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_ulong), ctypes.POINTER(ctypes.c_ulong), ctypes.POINTER(ctypes.c_float))(('BASS_ChannelGet3DAttributes', bass_module))
...
BASS_ChannelSet3DPosition = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR))(('BASS_ChannelSet3DPosition', bass_module))
#BOOL BASSDEF(BASS_ChannelGet3DPosition)(DWORD handle, BASS_3DVECTOR *pos, BASS_3DVECTOR *orient, BASS_3DVECTOR *vel);
BASS_ChannelGet3DPosition = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR))(('BASS_ChannelGet3DPosition', bass_module))
...
BASS_ChannelRemoveSync = func_type(ctypes.c_bool, ctypes.c_ulong, HSYNC)(('BASS_ChannelRemoveSync', bass_module))
...
BASS_ChannelRemoveDSP = func_type(ctypes.c_bool, ctypes.c_ulong, HDSP)(('BASS_ChannelRemoveDSP', bass_module))
#BOOL BASSDEF(BASS_ChannelSetLink)(DWORD handle, DWORD chan);
BASS_ChannelSetLink = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong)(('BASS_ChannelSetLink', bass_module))
#BOOL BASSDEF(BASS_ChannelRemoveLink)(DWORD handle, DWORD chan);
BASS_ChannelRemoveLink = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong)(('BASS_ChannelRemoveLink', bass_module))
...
BASS_ChannelRemoveFX = func_type(ctypes.c_bool, ctypes.c_ulong, HFX)(('BASS_ChannelRemoveFX', bass_module))

#BOOL BASSDEF(BASS_FXSetParameters)(HFX handle, const void *params);
BASS_FXSetParameters = func_type(ctypes.c_bool, HFX, ctypes.c_void_p)(('BASS_FXSetParameters', bass_module))
#BOOL BASSDEF(BASS_FXGetParameters)(HFX handle, void *params);
BASS_FXGetParameters = func_type(ctypes.c_bool, HFX, ctypes.c_void_p)(('BASS_FXGetParameters', bass_module))
